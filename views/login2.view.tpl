    ...
    <div class="col-md-4">
      <section class="login-form">
        <form method="post" action="#" role="login">
          <img src="http://www.soyservidor.com/site/wp-content/uploads/2014/02/ss-logo-8bits.png" class="img-responsive" alt="" />

          <input type="email" required class="form-control input-lg" name="txtUser" value="{{txtUser}}" placeholder="ejemplo@gmail.com"/>
            <input type="password" class="form-control input-lg"  id="password" name="txtPswd" value="{{txtPswd}}" placeholder="Contraseña" required="" />

          <div class="pwstrength_viewport_progress"></div>

           <input type="submit" class="btn btn-lg btn-primary btn-block" name="btnLogin" value="Ingresar"/>
